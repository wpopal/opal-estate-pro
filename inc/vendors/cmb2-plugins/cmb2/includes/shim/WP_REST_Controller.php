...
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		...
		_doing_it_wrong( 'WP_REST_Controller::register_routes', sprintf( __( "Method '%s' must be overridden.", 'opalestate-pro' ), __METHOD__ ), '4.7' );
	}
	...
	public function get_items_permissions_check( $request ) {
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass.", 'opalestate-pro' ), __METHOD__ ), array(
			'status' => 405,
		) );
	}
	...
	public function get_collection_params() {
		return array(
			...
			'search'                 => array(
				'description'        => __( 'Limit results to those matching a string.', 'opalestate-pro' ),
				'type'               => 'string',
	...
	public function get_context_param( $args = array() ) {
		$param_details = array(
			'description'        => __( 'Scope under which the request is made; determines fields present in response.', 'opalestate-pro' ),
			'type'               => 'string',
